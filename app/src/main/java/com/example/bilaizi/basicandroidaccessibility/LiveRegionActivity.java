...
public class LiveRegionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> androidVersions = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.android_versions)));
            ...
            radioGroup.setOnCheckedChangeListener(
                    (group, checkedId) -> {
                        ...
                        if (indexOfCheckedChild == correctAnswerIndex) {
                            ...
                            mFeedbackTextView.setBackgroundColor(ContextCompat.getColor(context, R.color.green));
                        } else {
                            mFeedbackTextView.setText(R.string.incorrect);
                            mFeedbackTextView.setBackgroundColor(ContextCompat.getColor(context, R.color.red));
                        }
                    });
        }
    }
